 ...
 */
      ...
      PyTuple_SET_ITEM(__pyx_t_12, 0, __pyx_kp_s_Unknown_bits_per_pixel);
      __Pyx_GIVEREF(__pyx_t_3);
 ...
 */
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_version, __pyx_kp_s_0_2_1) < 0) __PYX_ERR(0, 31, __pyx_L1_error)
