 ...
 */
          ...
          if (__pyx_t_22 < 0) {
            __pyx_t_9 = 0;
          } else if (unlikely(__pyx_t_22 >= __pyx_pybuffernd_images.diminfo[0].shape)) __pyx_t_9 = 0;
          if (unlikely(__pyx_t_9 != -1)) {
            __Pyx_RaiseBufferIndexError(__pyx_t_9);
